...
void saveBitmap(string fileName, int width, int height, std::function<unsigned char(int,int)> red, std::function<unsigned char(int, int)> green, std::function<unsigned char(int, int)> blue)
{
    unsigned char image[256][256][BYTES_PER_PIXEL] = { 0 };
    string file = (char*)"data/" + fileName;
