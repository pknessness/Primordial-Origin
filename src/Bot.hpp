...
public:
    ...
    virtual void OnGameStart() final {
        ...
        strat = &Strategem::shit_stalker_colossus;//&Strategem::gemini_chargelot_archon_disruptor;//&Strategem::chargelot_immortal_archon_timing;//&Strategem::classic_gsl_tempest_rush;//&Strategem::chirartem_proxy_dt;//&Strategem::zuka_proxy_tempest;//&Strategem::zuka_colossus_voidray;//&Strategem::pig_stalker_colossus;//&Strategem::hupsaiya_adept_timing;//
        ...
        for (const Unit* unit : units) {
            ...
            else if (Aux::isMineralType(unit->unit_type)) {
                pathingNum = 105;
            }
    ...
    virtual void OnUnitCreated(const Unit* unit) {
        ...
        if (unit->unit_type == UNIT_TYPEID::PROTOSS_PROBE) {
            ...
            } else if (unit->unit_type == UNIT_TYPEID::PROTOSS_DISRUPTOR) {
                new Disruptor(unit);
            } else if (unit->unit_type == UNIT_TYPEID::PROTOSS_DISRUPTORPHASED) {
                new PurificationNova(unit);
            } else {
                new ArmyUnit(unit);
            }
